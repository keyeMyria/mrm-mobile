...
public class RoomAvailabilityActivity extends AppCompatActivity implements
    ...
    protected void onActivityResult(
        ...
        switch (requestCode) {
            ...
            case REQUEST_ACCOUNT_PICKER:
                resultCodeEqualsResultOkAndDataNotNull(resultCode, data);
                break;
    ...
    /**
     * Extracted Method to cater to Result Code equaling ResultOk and Data not null.
     * @param resultCode integer of result code
     * @param data Data recieved via intent
     */
    public void resultCodeEqualsResultOkAndDataNotNull(int resultCode, Intent data) {
